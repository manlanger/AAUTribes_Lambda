...
public class TribesGatherResources implements RequestHandler<PlayerData, String> {
    ...
    public String handleRequest(PlayerData input, Context context) {
	    ...
	    int addedFood = input.getFoodCount();
	    int addedStone = input.getStoneCount();
	    int addedWood = input.getWoodCount();
	    
	    foodCount += addedFood;
	    stoneCount += addedStone;
	    woodCount += addedWood;
